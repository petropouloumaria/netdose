...
#'
#' @description
#' This dataset is a synthesis of randomized controlled studies investigating the effects of antidepressant
#' interventions for unipolar major depressive disorder.
#'
#' @details
#' The dataset includes data on several antidepressant agents and their observed effects
#' across multiple clinical randomized controlled trials. The primary outcome is the response rate,
#' defined as the proportion of patients achieving at least a 50% reduction in symptoms.
#'
...
#' the effects of the several agents across various doses.
#'
...
#' \tabular{rl}{
#'   \bold{\emph{drug}} \tab Character vector indicating the name of the antidepressant agent. \cr
#'   \bold{\emph{r}} \tab Integer vector for the number of participants who responded to treatment. \cr
#'   \bold{\emph{n}} \tab Integer vector for the total number of participants in the study arm. \cr
#'   \bold{\emph{dose}} \tab Numeric vector specifying the dose level of the antidepressant agent. \cr
...
#' with major depressive disorder: a systematic review and network meta-analysis. The Lancet. 2018;391:1357–1366.
#' @keywords datasets
#'
#' @examples
#' \donttest{
